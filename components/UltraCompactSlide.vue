...
<template>
  <div class="h-full flex flex-col bg-white dark:bg-gray-900">
    ...
    <div v-if="props.showHeader && props.title" class="mb-2">
      <h1 class="text-lg font-semibold text-gray-900 dark:text-white mb-0 tracking-tight">{{ props.title }}</h1>
...
<style scoped>
/* Ultra minimal content animation */
